...
@Component({
  selector: 'app-lot-releve-create-admin',
  standalone: false,
  templateUrl: './lot-releve-create-admin.component.html'
})
export class LotReleveCreateAdminComponent  implements OnInit {
   ...
   private _validLotReleveCode = true;
    ...
    public validateBatimentsCodeBatiment(){
    ...
    public validateBatimentsLibelle(){
    ...
    const isPermistted = await this.roleService.isPermitted('UniteReleve', 'add');
    if(isPermistted) {
