...
@Component({
  selector: 'app-unite-releve-list-admin',
  standalone: false,
  templateUrl: './unite-releve-list-admin.component.html'
})
export class UniteReleveListAdminComponent implements OnInit {

    protected fileName = 'UniteReleve';
    ...
    protected enableSecurity = false;
     ...
     yesOrNoActif: any[] = [];
    zoneAgenceReleves: Array<ZoneAgenceReleveDto>;


    constructor( private service: UniteReleveAdminService  , private zoneAgenceReleveService: ZoneAgenceReleveAdminService, private lotReleveService: LotReleveAdminService, @Inject(PLATFORM_ID) private platformId?: Object) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<UniteReleveDto>();
    ...
    public async edit(dto: UniteReleveDto) {
    ...
    public async view(dto: UniteReleveDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: UniteReleveDto) {
    ...
    public async duplicate(dto: UniteReleveDto) {
    ...
    public exportPdf(dto: UniteReleveDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'zoneAgenceReleve?.libelle', header: 'Zone agence releve'},
            {field: 'actif', header: 'Actif'},
        ];
    }


    public async loadZoneAgenceReleve(){
        this.zoneAgenceReleveService.findAllOptimized().subscribe(zoneAgenceReleves => this.zoneAgenceReleves = zoneAgenceReleves, error => console.log(error))
    }


	public initDuplicate(res: UniteReleveDto) {
        if (res.lotReleves != null) {
             res.lotReleves.forEach(d => { d.uniteReleve = null as any; d.id = null as any; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Zone agence releve': e.zoneAgenceReleve?.libelle ,
            ...
            //'Zone agence releve': this.criteria.zoneAgenceReleve?.libelle ? this.criteria.zoneAgenceReleve?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<UniteReleveDto> {
        return this.service.selections;
    }

    set selections(value: Array<UniteReleveDto>) {
