...
@Component({
  selector: 'app-unite-releve-create-admin',
  standalone: false,
  templateUrl: './unite-releve-create-admin.component.html'
})
export class UniteReleveCreateAdminComponent  implements OnInit {
   ...
   private _validUniteReleveLibelle = true;
    ...
    public validateLotRelevesNumero(){
    ...
    const isPermistted = await this.roleService.isPermitted('ZoneAgenceReleve', 'add');
    if(isPermistted) {
