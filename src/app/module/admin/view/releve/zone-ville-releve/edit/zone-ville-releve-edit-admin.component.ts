...
@Component({
  selector: 'app-zone-ville-releve-edit-admin',
  standalone: false,
  templateUrl: './zone-ville-releve-edit-admin.component.html'
})
export class ZoneVilleReleveEditAdminComponent implements OnInit {
 ...
 public edit(): void {
    ...
    public validateZoneVilleRegionReleves(){
    ...
    private validateZoneVilleRegionRelevesNumero(){
    ...
    private validateZoneVilleRegionRelevesLibelle(){
