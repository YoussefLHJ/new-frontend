...
@Component({
  selector: 'app-zone-ville-releve-list-admin',
  standalone: false,
  templateUrl: './zone-ville-releve-list-admin.component.html'
})
export class ZoneVilleReleveListAdminComponent implements OnInit {

    protected fileName = 'ZoneVilleReleve';
    ...
    constructor( private service: ZoneVilleReleveAdminService  , private zoneVilleRegionReleveService: ZoneVilleRegionReleveAdminService, @Inject(PLATFORM_ID) private platformId?) {
        ...
        this.pdfName = 'ZoneVilleReleve.pdf';
    }
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ZoneVilleReleveDto>();
    ...
    public async edit(dto: ZoneVilleReleveDto) {
    ...
    public async view(dto: ZoneVilleReleveDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ZoneVilleReleveDto) {
    ...
    public async duplicate(dto: ZoneVilleReleveDto) {
    ...
    public exportPdf(dto: ZoneVilleReleveDto): void {
...
// add
    ...
    get selections(): Array<ZoneVilleReleveDto> {
        return this.service.selections;
    }

    set selections(value: Array<ZoneVilleReleveDto>) {
