...
@Component({
  selector: 'app-zone-agence-releve-list-admin',
  standalone: false,
  templateUrl: './zone-agence-releve-list-admin.component.html'
})
export class ZoneAgenceReleveListAdminComponent implements OnInit {

    protected fileName = 'ZoneAgenceReleve';
    ...
    protected enableSecurity = false;
     ...
     yesOrNoActif: any[] = [];
    zoneVilleRegionReleves: Array<ZoneVilleRegionReleveDto>;


    constructor( private service: ZoneAgenceReleveAdminService  , private uniteReleveService: UniteReleveAdminService, private zoneVilleRegionReleveService: ZoneVilleRegionReleveAdminService, @Inject(PLATFORM_ID) private platformId?: Object) {
        ...
        this.pdfName = 'ZoneAgenceReleve.pdf';
    }
    ...
    ngOnInit(): void {
        ...
        this.initExport();
        this.initCol();
        this.loadZoneVilleRegionReleve();
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ZoneAgenceReleveDto>();
    ...
    public async edit(dto: ZoneAgenceReleveDto) {
    ...
    public async view(dto: ZoneAgenceReleveDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ZoneAgenceReleveDto) {
    ...
    public async duplicate(dto: ZoneAgenceReleveDto) {
    ...
    public exportPdf(dto: ZoneAgenceReleveDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'zoneVilleRegionReleve?.libelle', header: 'Zone ville region releve'},
            {field: 'actif', header: 'Actif'},
        ];
    }


    public async loadZoneVilleRegionReleve(){
        this.zoneVilleRegionReleveService.findAllOptimized().subscribe(zoneVilleRegionReleves => this.zoneVilleRegionReleves = zoneVilleRegionReleves, error => console.log(error))
    }


	public initDuplicate(res: ZoneAgenceReleveDto) {
        if (res.uniteReleves != null) {
             res.uniteReleves.forEach(d => { d.zoneAgenceReleve = null as any; d.id = null as any; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Zone ville region releve': e.zoneVilleRegionReleve?.libelle ,
            ...
            //'Zone ville region releve': this.criteria.zoneVilleRegionReleve?.libelle ? this.criteria.zoneVilleRegionReleve?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<ZoneAgenceReleveDto> {
        return this.service.selections;
    }

    set selections(value: Array<ZoneAgenceReleveDto>) {
