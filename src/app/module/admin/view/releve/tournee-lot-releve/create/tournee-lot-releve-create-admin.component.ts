...
@Component({
  selector: 'app-tournee-lot-releve-create-admin',
  standalone: false,
  templateUrl: './tournee-lot-releve-create-admin.component.html'
})
export class TourneeLotReleveCreateAdminComponent  implements OnInit {
