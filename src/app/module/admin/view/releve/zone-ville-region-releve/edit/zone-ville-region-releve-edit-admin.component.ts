...
@Component({
  selector: 'app-zone-ville-region-releve-edit-admin',
  standalone: false,
  templateUrl: './zone-ville-region-releve-edit-admin.component.html'
})
export class ZoneVilleRegionReleveEditAdminComponent implements OnInit {
 ...
 public edit(): void {
    ...
    public validateZoneAgenceReleves(){
    ...
    private validateZoneAgenceRelevesNumero(){
    ...
    private validateZoneAgenceRelevesLibelle(){
   ...
   public async openCreateZoneVilleReleve(zoneVilleReleve: string) {
        const isPermistted = await this.roleService.isPermitted('ZoneVilleReleve', 'edit');
        if (isPermistted) {
