...
@Component({
  selector: 'app-zone-ville-region-releve-list-admin',
  standalone: false,
  templateUrl: './zone-ville-region-releve-list-admin.component.html'
})
export class ZoneVilleRegionReleveListAdminComponent implements OnInit {

    protected fileName = 'ZoneVilleRegionReleve';
    ...
    protected enableSecurity = false;
     ...
     yesOrNoActif: any[] = [];
    zoneVilleReleves: Array<ZoneVilleReleveDto>;


    constructor( private service: ZoneVilleRegionReleveAdminService  , private zoneAgenceReleveService: ZoneAgenceReleveAdminService, private zoneVilleReleveService: ZoneVilleReleveAdminService, @Inject(PLATFORM_ID) private platformId?) {
        ...
        this.pdfName = 'ZoneVilleRegionReleve.pdf';
    }
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ZoneVilleRegionReleveDto>();
    ...
    public async edit(dto: ZoneVilleRegionReleveDto) {
    ...
    public async view(dto: ZoneVilleRegionReleveDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ZoneVilleRegionReleveDto) {
    ...
    public async duplicate(dto: ZoneVilleRegionReleveDto) {
    ...
    public exportPdf(dto: ZoneVilleRegionReleveDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'zoneVilleReleve?.libelle', header: 'Zone ville releve'},
            {field: 'actif', header: 'Actif'},
        ];
    }


    public async loadZoneVilleReleve(){
        this.zoneVilleReleveService.findAllOptimized().subscribe(zoneVilleReleves => this.zoneVilleReleves = zoneVilleReleves, error => console.log(error))
    }


	public initDuplicate(res: ZoneVilleRegionReleveDto) {
        if (res.zoneAgenceReleves != null) {
             res.zoneAgenceReleves.forEach(d => { d.zoneVilleRegionReleve = null; d.id = null; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Zone ville releve': e.zoneVilleReleve?.libelle ,
            ...
            //'Zone ville releve': this.criteria.zoneVilleReleve?.libelle ? this.criteria.zoneVilleReleve?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<ZoneVilleRegionReleveDto> {
        return this.service.selections;
    }

    set selections(value: Array<ZoneVilleRegionReleveDto>) {
