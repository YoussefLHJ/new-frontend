...
@Component({
  selector: 'app-tournee-releve-compteur-create-admin',
  standalone: false,
  templateUrl: './tournee-releve-compteur-create-admin.component.html'
})
export class TourneeReleveCompteurCreateAdminComponent  implements OnInit {
	...
	constructor(private service: TourneeReleveCompteurAdminService , private appareilService: AppareilAdminService, private tourneeReleveDetailService: TourneeReleveDetailAdminService, @Inject(PLATFORM_ID) private platformId?: Object ) {
    ...
    const isPermistted = await this.roleService.isPermitted('TourneeReleveDetail', 'add');
    if(isPermistted) {
