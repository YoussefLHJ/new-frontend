...
export class BatimentViewAdminComponent implements OnInit {
    ...
    appareil = new AppareilDto();
    appareils: Array<AppareilDto> = [];

    constructor(private service: BatimentAdminService, private communeService: CommuneAdminService, private appareilService: AppareilAdminService, private lotReleveService: LotReleveAdminService){
