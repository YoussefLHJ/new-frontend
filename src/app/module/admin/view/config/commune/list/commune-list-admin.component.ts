...
export class CommuneListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CommuneDto>();
    ...
    public async edit(dto: CommuneDto) {
    ...
    public async view(dto: CommuneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
	...
	public async openEdit(dto: CommuneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
    ...
    public async duplicate(dto: CommuneDto) {
    ...
    public exportPdf(dto: CommuneDto): void {
...
// add
	...
	public initDuplicate(res: CommuneDto) {
	}
    ...
    get selections(): Array<CommuneDto> {
        return this.service.selections;
    }

    set selections(value: Array<CommuneDto>) {
