...
@Component({
  selector: 'app-commune-view-admin',
  standalone: false,
  templateUrl: './commune-view-admin.component.html'
})
export class CommuneViewAdminComponent implements OnInit {
    ...
    constructor(private service: CommuneAdminService){
