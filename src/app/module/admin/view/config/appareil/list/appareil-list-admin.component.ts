...
export class AppareilListAdminComponent implements OnInit {
    ...
    public async delete(dto: AppareilDto) {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'numeroAppareil', header: 'Numero appareil'},
        ...
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						'Numero appareil': e.numeroAppareil ,
						'Batiment': e.batiment?.libelle ,
					}
				});

            this.criteriaData = [{
                'Numero appareil': this.criteria.numeroAppareil ? this.criteria.numeroAppareil : environment.emptyForExport ,
