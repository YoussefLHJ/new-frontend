    ...
    ngOnInit(): void {
        this.activateSecurityConstraint('User').subscribe(() => {
            if (this.listActionIsValid) {
                ...
                this.initExport();
                this.initCol();
                this.yesOrNoCredentialsNonExpired = [
                    { label: 'CredentialsNonExpired', value: null },
                    {
                        label: 'Oui',
                        value: 1
                    },
                ...
                this.yesOrNoEnabled = [
                    { label: 'Enabled', value: null },
                    { label: 'Oui', value: 1 },
                    { label: 'Non', value: 0 }
                ];
                this.yesOrNoAccountNonExpired = [
                    { label: 'AccountNonExpired', value: null },
                    {
                        label: 'Oui',
                        value: 1
                    },
                ...
                this.yesOrNoAccountNonLocked = [
                    { label: 'AccountNonLocked', value: null },
                    {
                        label: 'Oui',
                        value: 1
                    },
                ...
                this.yesOrNoPasswordChanged = [
                    { label: 'PasswordChanged', value: null },
                    {
                        label: 'Oui',
                        value: 1
                    },
